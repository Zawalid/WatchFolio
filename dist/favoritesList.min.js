...
`);p.querySelector("#favorites").innerHTML=t,h=[...p.querySelectorAll("[data-id]")]},L=(s(f,p,"favorite",y),o("removeFromFavoriteList",p,"favorite",x,y,g),e("favoritesList_toggler",p,u,y),t("favoritesList_toggler",p,u,y),r(p,x,"favorite",y),i(p),p.querySelector("input"));u.querySelector("#search").addEventListener("click",()=>{c(p,L,x,"favorite")}),L.addEventListener("keyup",e=>{"Enter"===e.key&&(l(L,p,h),n(L))});export{x as favoritesList,w as addToFavoritesList,g as removeFromFavoritesList};